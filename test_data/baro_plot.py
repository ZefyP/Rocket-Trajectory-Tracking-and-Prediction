# this script plots karman mini rocket test flight data that was collected in November 2022
...
# C:/ergasia/projects/Rocket-Trajectory-Tracking-and-Prediction/test_data/kminibaro.txt
...
with open('C:/ergasia/projects/Rocket-Trajectory-Tracking-and-Prediction/test_data/kminiaccel.txt', 'r') as datafile:
	plotting = csv.reader(datafile, delimiter=',')
...
axis[1,1].plot(x_values, y_values)
axis[1,1].set_title('Altitude',wrap=True)
axis[1,1].set_xlabel('Time(s)')
axis[1,1].set_ylabel('Altitude (m/s)')

axis[1,0].plot(x_values, y_values)
axis[1,0].set_title('Atmospheric Model',wrap=True)
axis[1,0].set_xlabel('Pressure (atm)')
