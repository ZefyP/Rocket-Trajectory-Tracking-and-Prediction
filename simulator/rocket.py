# In the file trajectory_prediction.py

# def predict_trajectory():
#   # Predict the future trajectory of the rocket using your chosen prediction method
#   predicted_trajectory = predict()

#   # Update the trajectory label to display the predicted trajectory
#   trajectory_label["text"] = "Predicted Trajectory: " + predicted_trajectory
...
from .launchsite import Launcher
from .ambiance import Atmosphere
from .utilities import normalise_vector, lla2ecef
    ...
    def run_simulation(self):
        ...
        while i < N_TIME_INTERVALS - 1:
            ...
            for stage in self.stages:
                ...
                # by default each stage has no thrust
                thrust_magnitude = 0
            ...
            if time() - last_progress_print > 0.1:
                ...
                self.log(f"[{self.name}] Solving {i}/{N_TIME_INTERVALS} ({percentage}%)")
